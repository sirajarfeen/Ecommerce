    ...
    <Document>
        <Page style={styles.body}>
            ...
            <Table data={order.products}>
                <TableBody>
                    <DataTableCell getContent={(x) => x.products.title} />
                    <DataTableCell getContent={(x) => `$${x.products.price}`} />
                    <DataTableCell getContent={(x) => x.count} />
                    <DataTableCell getContent={(x) => x.products.brand} />
                    <DataTableCell getContent={(x) => x.products.color} />
                </TableBody>
            </Table>
